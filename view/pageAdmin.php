        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li id="menu-acceuil"class="nav-item ">
              <a class="nav-link" href="./index_acceuil_admin.php">Acceuil<span class="sr-only">(current)</span></a>
            </li>
            <li id="menu-gestion-recette" class="nav-item ">
              <a class="nav-link" href="./index_admin.php">Gestion recettes</a>
            </li>
            <li id="menu-gestion-news" class="nav-item ">
              <a class="nav-link" href="#">Gestion news</a>
            </li>
            <li id="menu-gestion-utilisateurs" class="nav-item ">
              <a class="nav-link" href="./index_gestion_user.php">Gestion utilisateurs</a>
            </li>
            <li id="menu-gestion-nutrition" class="nav-item ">
                <a class="nav-link" href="./index_admin_ingrédiant.php">Gestion nutrition</a>
            </li> 
            <li id="menu-option" class="nav-item ">
                <a class="nav-link" href="./index_option.php">Options</a>
            </li> 
        <?php
    }
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li id="menu-news" class="nav-item ">
              <a class="nav-link" href="#">Gestion recettes</a>
            </li>
            ...
            <li id="menu-saisons" class="nav-item ">
                <a class="nav-link" href="#">Gestion nutrition</a>
            </li> 
            </nav>
  </footer>
  </div>
